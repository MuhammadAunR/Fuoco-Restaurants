  ...
  return (
    <section className='min-h-screen bg-mist-900 text-white py-16 px-6 lg:px-20'>
      <div className='max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start'>
        ...
        <div data-aos='fade-up' className='flex flex-col gap-10 lg:sticky lg:top-24'>
        ...
        {/* ── Right — Form ── */}
        <div data-aos='fade-up' className='bg-mist-800 border border-primary/15 p-8 flex flex-col gap-7 h-fit min-h-screen'>
